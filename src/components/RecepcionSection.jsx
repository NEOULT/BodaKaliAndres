  ...
  return (
    <LandingSection>
      <div className="recepcion-section">
        ...
        <ThemedText variant="subtitle" style={{ fontFamily: 'Gilroy-ExtraBold, sans-serif', color: '#B1732A', fontSize: '1.25rem', textAlign: 'center', fontWeight: 700, marginBottom: 2, letterSpacing: '5px' }}>
          PICAÑA GRILL
        </ThemedText>
        <ThemedText variant="default" style={{ fontFamily: 'Gilroy-Light, sans-serif', color: '#B1732A', fontSize: '1.25rem', textAlign: 'center', marginBottom: 12, letterSpacing: '5px' }}>
          CALLE 73 C / AV 16A
        </ThemedText>
